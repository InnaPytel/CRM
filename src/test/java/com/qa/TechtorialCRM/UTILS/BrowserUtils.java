package com.qa.TechtorialCRM.UTILS;
...
public class BrowserUtils {
    ...
    public static void slectBy(WebElement location,String value,String methodName){
        ...
        switch (methodName){
            ...
            default:
                Assert.fail("Please provide text,value or index for methodNam");
        }
    }
